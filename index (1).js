...
document.addEventListener("DOMContentLoaded", function() {
   ...
   document.querySelectorAll(", customDropDown"),forEach(function (dropdown) {
      ...
      if (e.target.classList.contains("crossString") || e.target.classList.contains("bowrio")) {
         return false;
      }
      ...
      var customDrp =  this.nextElementSibling || this.querySelector(".customDrp");
      if (customDrp) {
   ...
   document.querySelector(".basic_banner_read_btn").addEventListener("click", function() {
      if (basic_banner_read_btn == false) {
         ...
         document.querySelector(".basic_banner_text").classList.toggle("slide-google");
         basic_banner_read_btn = true;
      } else {
         document.querySelector(".basic_banner_text").classList.toggle("slide-toggle");
   ...
   // filterToggelBtn
   document.querySelector(".filterToggleBtn").addEventListener("click", function() {
      document.querySelector(".filterToggleBtn").classList.toggle("active");
   });

   // ==  .hideCustomDrp == //
   document.querySelector(".hideCustomDrp").addEventListener("click", function(){
      document.querySelector(".hideCustomDrp").forEach(function (el) {
   ...
   // document.querySelector(".customPopup").addEventListener("click", function(){
   //    this.classList.remove("active");
   // });

   document.querySelector(".closeIcon").addEventListener("click"),function(){
      document.querySelector(".customPopup").forEach(function (el) {
         el.classList.remove("active");
      });
      document.querySelectorAll(".commonPopup").forEach(function (el){
         el.classList.remove("active");
      });
   ...
   document.querySelector(".mainTable").addEventListener("scroll", function (e) {
      ...
      if(isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(3), td:nth-child(3)").forEach(function (el){
   ...
   document.querySelectorAll(".currenciesTable, .exchangeTable").forEach(function (table) {
      table.addEventListener("scroll", function (e) {
         let isScroll = e.currentTarget.scrollLeft;
         if(isScroll){
            document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function (el){
               el.classList.add("before");
            });
         } else {
            document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function (el){
   ...
   document.querySelector(".historical-data").addEventListener("scroll",function (e) {
      let isScroll = e.currentTarget.scrollLeft;
      if(isScroll){
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function (el){
            el.classList.add("before");
         });
      } else {
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function (el){
   ...
   document.addEventListener("scroll", function (){
      ...
      if(scrolled > 200){
         document.querySelector(".gototopIconDiv").style.display = "block";
      } else {
         document.querySelector(".gototopIconDiv").style.display = "none";
      }
   });
   ...
   // ==  .LoginSignUpBox == //
   // document.querySelector(".LoginSignUpBox .TabsHead").addEventListner("click", function () {
   //   let obj = this;
   //   obj.addClass("active").siblings().removeClass("active");
   //   document.querySelector(obj.getAttibute("data-tab")).classList.add("active");
   //   document.querySelector(obj.getAttibute("data-tab")).siblings().classList.remove("active");
   // });

   document.querySelector(".popupRecover").addEventListener("click", function (){
   ...
   let isHighLight = document.getElementById("HighlightBox");
   isHighLight.addEventListener("click", function(){
      document.querySelector(".Banner_cards").classList.toggle("slide-toggle");
   });
